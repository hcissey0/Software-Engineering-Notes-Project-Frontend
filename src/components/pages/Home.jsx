...
const Home = () => {
  ...
  return (
    <div className="flex flex-col gap-5 justify-center items-center">
      <div className="borde w-full flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <form className="max-w-sm w-20">
            ...
            id="underline_select" className="block py-2.5 px-0 w-full text-sm text-gray-700 bg-transparent border-0 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
        ...
        <div className="flex items-center">
          <ul className="flex items-center">
            <li>
                ...
                type="radio" id="hosting-small" name="display" value="list" className="hidden peer" />
            ...
            <li>
                <input
                onChange={handleDisplayMode}
                type="radio" id="hosting-big" name="display" value="grid" className="hidden peer" defaultChecked />
      ...
      <div className={`transition-all max-w-1/2 flex w-full justify-center items-center ${displayMode === 'list' ? 'flex-col' : 'flex-wrap'} gap-4`}>
        {
          notes.map(
            (note) =>
