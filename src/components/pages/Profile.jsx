    ...
    <div>
      <div id="imageModal" className="modal">
        <div className="modal-content">
          ...
          <h2 className="dark:text-black">Image Preview</h2>
      ...
      <div className="profile-container">
        <div className="cover-photo">
          ...
          <button id="editImageButton">
            <svg
              className="w-[39px] h-[39px] text-blue-800 dark:text-white camera"
              aria-hidden="true"
        ...
        <div className="profile-information-container shadow-lg">
          <div className="profile-information-box">
            <label className="edit-profile dark:text-white">Profile</label>
            <h3 className="dark:text-white">{name}</h3>
            <h1 className="dark:text-white">{phone}</h1>
            <h1 className="dark:text-white">{email}</h1>
            <h1 className="dark:text-white">Number of notes: </h1>
      ...
      {isProfileModalOpen && (
        <div className="edit-modal">
          <div className="edit-modal-content">
            <span className="close-btn" onClick={closeProfileModal}>
              &times;
            </span>
            <h2>Edit Profile</h2>
