...
const Home = () => {
  ...
  useEffect(() => {
        ...
        */ 
      const func = async ()=>{
        const notes = await fromServers([DOMAIN + '/api/get-notes/', JSON_DOMAIN + '/get-notes/'], {auth:true}); // remove auth for when using json server (json server doesn't accept authorization)
